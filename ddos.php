...
<div class="container">
    ...
    <form onsubmit="submitForm(event)">
        ...
        <div>
        <input type="radio" name="reponse" value="c" label for="reponse_c"> Destruction de Données sur le Système.<br>
    </div>
        <div>
        <input type="radio" name="reponse" value="b" label for="reponse_b"> Déconnexion Directe du Système.<br>
    </div>
        <div>
        <input type="radio" name="reponse" value="a" label for="reponse_a"> Déni de service distribué<br>
    </div>
        <div>
        <input type="radio" name="reponse" value="d" label for="reponse_d"> Double Débordement de Système.<br>
    </div>
...
function changeQuestion() {
    ...
    window.open("https://fr.wikipedia.org/wiki/Attaque_par_d%C3%A9ni_de_service", "_blank");
};
