...
<div class="container text-center">
    ...
    <div class="row">
        <div class="col-sm-4"> <!-- Adjusted from col-sm-6 to col-sm-4 -->
            <a href="crypto2.php">
                <button class="btn btn-block btn-default" style="margin-top:20px"> Niveau facile</button>
                <img src="assets/img/protocoles/CRYPT.png" alt="Un message crpyté avec le chiffrement de césar (facile)">   
            </a>
        </div>
        <div class="col-sm-4"> <!-- Adjusted from col-sm-6 to col-sm-4 -->
            <a href="crypto.php">
                <button class="btn btn-block btn-default" style="margin-top:20px">Niveau difficle</button>
                <img src="assets/img/protocoles/PASSWORD.png" alt="Un mot de passe crpyté à retrouver (difficle)">
            </a>
        </div>
        <div class="col-sm-4"> <!-- Adjusted from col-sm-6 to col-sm-4 -->
            <a href="injection.php">
                <button class="btn btn-block btn-default" style="margin-top:20px">Injection SQL</button>
                <img src="assets/img/protocoles/INFO.png" alt="Obtenir des informations confidentielles avec une injection SQL">
            </a>
        </div>
